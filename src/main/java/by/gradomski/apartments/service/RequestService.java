...
public interface RequestService {
    ...
    List<Request> getActiveRequestsByApartmentId(long apartmentId) throws ServiceException;
    List<Request> getRequestsByApplicantId(long applicantId) throws ServiceException;
